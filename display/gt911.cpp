...
esp_lcd_touch_handle_t touch_gt911_init(DEV_I2C_Port i2cPort, bool mirrorX, bool mirrorY, bool swapXY)
{
    ...
    ESP_LOGI(TAG, "Initialize I2C tag IO");  // Log I2C panel I/O initialization
    // Create a new I2C panel I/O handle for the touch controller
    ESP_ERROR_CHECK(esp_lcd_new_panel_io_i2c(i2cPort.bus, &tp_io_config, &tp_io_handle));
    ...
    const esp_lcd_touch_config_t tp_cfg = {
        ...
        .flags = {
            .swap_xy = swapXY,  // No swap of X and Y coordinates
            .mirror_x = mirrorX,  // No mirroring of X axis
            .mirror_y = mirrorY,  // No mirroring of Y axis
        },
    };
